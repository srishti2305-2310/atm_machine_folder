...
def transaction_history(request):
    ...
    try:
        ...
        #
        # deposit_amount = sum(transaction.deposit_amount for transaction in transactions)
        # withdraw_amount = sum(transaction.withdraw_amount for transaction in transactions)
        #
